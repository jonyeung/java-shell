...
public class MatchRegexTest {
  ...
  public void setUp() {
    ...
    root.storeFile(new TextFile("doc",
        "As a doctor, I think we should\n" + "do that thing\n"
            + "You know what thing I'm talking about right?\n"
            + "The thing with the carrot\n" + "like what's up doc.",
        root));
    root.storeFile(
        new TextFile("movie",
            "This is the day we saw that thing\n"
                + "That thing was at the movie\n"
                + "You know about the popcorn and that guy",
            root));
    ...
    dir1.storeFile(new TextFile("secret",
        "my secret is...\n" + "I'm always angry said the Hulk\n"
            ...
            + "and looking all cool and green",
        dir1));
  }
  ...
  public void testGrepMultipleFiles() throws CommandException {
    ...
    result = MatchRegex.executeGrep(fileSystem, args);
    expected = "dir1/secret: I'm always angry said the Hulk\n"
